...
public class SqliteDatasourceType extends CustomFlightDatasourceType
{
    /**
     * An instance of the custom Apache Derby data source type.
     */
    public static final SqliteDatasourceType INSTANCE = new SqliteDatasourceType();

    /**
     * The unique identifier name of the data source type.
     */
    public static final String DATASOURCE_TYPE_NAME = "sqlite_connector";
    private static final String DATASOURCE_TYPE_LABEL = "sqlite";
    private static final String DATASOURCE_TYPE_DESCRIPTION = "sqlite (SDK)";

    public SqliteDatasourceType()
    {
        super();
